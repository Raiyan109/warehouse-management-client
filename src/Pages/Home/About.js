            ...
            <div className="max-w-screen-xl px-4 md:px-8 mx-auto">
                <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="md:pt-8">
                        ...
                        <h1 className="text-gray-800 text-2xl sm:text-3xl font-bold text-center md:text-left mb-4 md:mb-6">Welcome to our hiking gear warehouse management website!</h1>
