...
const CallToAction = () => {
    return (
        ...
        <div className="p-4 lg:mt-[350px] md:mt-[990px] w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Work fast from anywhere</h5>
            <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and move work forward with Hiking Inventory on iOS &amp; Android. Download the app today.</p>
